...
Modified by Pawel Rosikiewicz 28.06.2022

@author: Chonghua Xue (Kolachalama's Lab, BU)
"""

from src.utils.lstm_bi import LSTM_Bi
from src.utils.utils_data import ProteinSeqDataset, aa2id_i, aa2id_o, collate_fn
